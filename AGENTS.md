...
All directories below exist. `rig/` implements spine and limb binding; `anim/` implements pose evaluation, bend diagnostics, both phases of Particle IK, static standing, and a first walking preview. Constraint tuning, dynamic balance, full orientation goals, head stabilization and secondary motion beyond tails remain planned.
